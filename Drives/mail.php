				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">KIET Group of Institutions<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<p>Delhi-NCR,Meerut Road(NH-58)
						<span>Ghaziabad-201206</span>
						India 
					</p>
					<h4>Contact Us</h4>
					<p>Telephone: 01232-227980
						<span>FAX: +91 1234-567488</span>
						E-mail: <a href="mailto:kiet.edu">kiet.edu</a>
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>KIET
							<span>Delhi-NCR,Meerut Road(NH-58)</span>
						</p>
					</div>
					<div class="phone">
						<p>1234567890</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">KIET Group of Institutions</h6>
					<h4>
